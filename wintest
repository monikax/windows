...
link1_status=$(curl -Is http://vm.abcvg.work/en_windows_server_2012_R2_vl_x64_by_AG_05.2019.iso | grep HTTP | cut -f2 -d" " | head -1)
link2_status=$(curl -Is http://vm.abcvg.work/en_windows_server_2012_R2_vl_x64_by_AG_05.2019.iso | grep HTTP | cut -f2 -d" ")
#sudo wget -P /mediabots http://vm.abcvg.work/en_windows_server_2012_R2_vl_x64_by_AG_05.2019.iso # Windows Server 2012 R2 
if [ $link1_status = "200" ] ; then 
	sudo wget http://vm.abcvg.work/en_windows_server_2012_R2_vl_x64_by_AG_05.2019.iso 
